...
import { updateFirstTimeUser2, updateProUser, updatecredits,updateFirstTimeProuser } from '@/utils/supabase/subscriptionUtils'; 
...
export async function POST(req: NextRequest) {
  try {
    ...
    await updateFirstTimeProuser(supabase, email, true);
